---
tipo: concepto
titulo: Marco normativo (Manta / SOAT)
tags: [legal, regulatorio, normativa]
creado: 2026-08-13
...
# Marco normativo (Manta / SOAT)

**Definición corta:** Conjunto de normas del sector asegurador, NIIF y SOAT que rigen la contabilidad y el
cumplimiento de [[entidades/manta-seguros|Manta Seguros]].

## Normativa del sector asegurador

| Norma | Referencia | Contenido |
|-------|-----------|-----------|
| EOSF | Decreto 663 de 1993 | Régimen legal de aseguradoras. Arts. 192-193 (SOAT). |
| **CBF** (Circular Básica Financiera) | CE 004 de 2026 | Instrucciones prudenciales, contables y de reporte. Sustituyó la CBCF (CE 100/1995). |
...
1. Instrucciones prudenciales de la SFC (CBF, circulares) — prevalecen en materia prudencial.
2. NIIF adoptadas en Colombia (Decreto 2420/2015 y mod.) — marco técnico contable general.
3. NIIF del IASB, en ausencia de instrucción SFC.
4. Normativa fiscal (ET) — rige **solo el libro fiscal**, no afecta la medición NIIF.
...
- Relacionado con: [[entidades/superintendencia-financiera]] · [[conceptos/patrimonio-y-solvencia]] · [[conceptos/soat]]
- Aparece en: [[fuentes/manual-politicas-contables-manta]] (Parte I §1)
